	...
	_createClass(ChartCanvas, [{
		...
		value: function handlePinchZoomEnd(initialPinch, e) {
			...
			if (this.finalPinch) {
				...
				var _props = this.props,
				    ...
				    onLoadAfter = _props.onLoadAfter,
				    onLoadBefore = _props.onLoadBefore;
		...
		value: function handleZoom(zoomDirection, mouseXY, e) {
			...
			var _props3 = this.props,
			    ...
			    onLoadAfter = _props3.onLoadAfter,
			    onLoadBefore = _props3.onLoadBefore;
		...
		value: function xAxisZoom(newDomain) {
			...
			var _props4 = this.props,
			    ...
			    onLoadAfter = _props4.onLoadAfter,
			    onLoadBefore = _props4.onLoadBefore;
		...
		value: function handlePanEnd(mousePosition, panStartXScale, dxdy, chartsToPan, e) {
			...
			requestAnimationFrame(function () {
				...
				var _props5 = _this5.props,
				    ...
				    onLoadAfter = _props5.onLoadAfter,
				    onLoadBefore = _props5.onLoadBefore;
